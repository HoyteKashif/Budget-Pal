...
public class StaticMonthlyBillsHelper {
	 ...
	 * @return
	 */
	public static LocalDate getNextBillDueDate(final Bill p_oBill) {
	 ...
	 * @return
	 */
	public static List<LocalDate> getNextBillDueDates(final Bill p_oBill, final int p_iNumberOfDates) {
